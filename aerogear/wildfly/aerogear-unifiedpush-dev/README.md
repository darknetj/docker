...
`docker run -it -p 8443:8443 abstractj/unifiedpush-wildfly-dev:201408080346`

## Building the image (alternative)

Clone the repo and build yourself:

`docker build -t abstractj/unifiedpush-wildfly-dev:201408080346 .`
...
`docker run --rm -it --entrypoint=/bin/bash abstractj/unifiedpush-wildfly-dev:201408080346 && cd ..`
